...
class S201_BAI_Table extends WP_List_Table {
	...
	function column_shortcode($item) {
		$actions = array(
			...
			'delete' => sprintf('<a href="?page=%s&action=%s&id=%s&_wpnonce=%s" onclick="return confirm(\'Are you sure you want to delete this item?\');">Delete</a>','s201-bai-slider','delete',$item->id,wp_create_nonce('delete_item'.$item->id)),
		);
